...
public class DriverUserDetailsAdapter implements UserDetailsAdapter{

    private final DriverAccount account;

    public DriverUserDetailsAdapter(DriverAccount account){
